...
// The watchlist is backed by Jellyfin "Likes" — the same flag the WatchlistButton
// toggles. Reuse the generic items grid filtered to liked Movies & Series.
...
const MyListPage = () => {
    ...
    const title = t('my_list', { defaultValue: 'My List' });
